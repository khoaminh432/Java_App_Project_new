...
public class StudentDao implements Generic<StudentDTO> {
    ...
    public int findNextID() {
        return queryExecutor.NextID(tableName);
    }
    ...
    public int insert(StudentDTO obj) {
        String query = "INSERT INTO students (id, name, surname, create_time, birth_date, hometown)VALUES (?, ?, ?, ?, ?, ?)";
        int a = queryExecutor.ExecuteUpdate(query, obj.getId(), obj.getName(), obj.getSurname(), obj.getCreatetime(), obj.getBirthdate(), obj.getHometown());
        return a;
    }
